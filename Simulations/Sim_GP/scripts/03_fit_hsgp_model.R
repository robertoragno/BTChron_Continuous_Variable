#' Purpose: Fit the HSGP model with latent date inference to the simulated data.
...
model <- cmdstan_model(here("Simulations", "Sim_GP", "models", "sim_hsgp.stan"))
...
fit$save_object(here("Simulations", "Sim_GP", "output", "fit_hsgp.rds"))
