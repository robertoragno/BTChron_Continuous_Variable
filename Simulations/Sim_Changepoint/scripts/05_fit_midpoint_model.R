#' Purpose: Fit the changepoint midpoint model (no latent date inference)
...
fit$save_object(
  here("Simulations", "Sim_Changepoint", "output", "fit_midpoint.rds")
)

fit$cmdstan_diagnose()

cat("\n── Midpoint model parameter recovery ──\n")
print(fit$summary(variables = c("baseline_original", "slope1_original",
