...
sim_data     <- read_csv(here("Simulations", "Sim_Changepoint", "data", "simulated_data.csv"),
                         show_col_types = FALSE)
ground_truth <- read_csv(here("Simulations", "Sim_Changepoint", "data", "ground_truth.csv"),
                         show_col_types = FALSE)
...
cat("Saved to", here("Simulations", "Sim_Changepoint", "figures", "exploratory_panel.png"), "\n")
